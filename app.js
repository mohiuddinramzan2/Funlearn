...
function switchMode(mode) {
  currentMode = mode;
  document.getElementById('alphaMode').style.display = mode === 'alpha' ? 'block' : 'none';
  document.getElementById('numMode').style.display = mode === 'num' ? 'block' : 'none';
...
window.showTab = function(name) {
  ...
  document.getElementById(activeTabBtn[name]).classList.add('active');
  ...
  if (currentMode === 'alpha') {
    ...
    document.getElementById(`tab-num-${name}`).classList.add('active');
...
window.toggleNumSong = toggleNumSong;
window.clearActiveCanvas = clearActiveCanvas;
window.praiseKid = praiseKid;
window.updateBrushLabel = updateBrushLabel;
